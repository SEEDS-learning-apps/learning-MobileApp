...
class FlashcardAdapter(val context: FlashCards):  RecyclerView.Adapter<FlashcardAdapter.exViewholder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FlashcardAdapter.exViewholder {
    ...
    override fun onBindViewHolder(holder: FlashcardAdapter.exViewholder, position: Int) {
